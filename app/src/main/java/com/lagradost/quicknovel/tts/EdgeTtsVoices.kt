...
sealed class ReaderTtsVoice {
    data object Default : ReaderTtsVoice()
    data class System(val voice: Voice) : ReaderTtsVoice()
    data class Edge(val voice: EdgeTtsVoice) : ReaderTtsVoice()
}
